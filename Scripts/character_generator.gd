...
var first_names : Array = ["John", "Maryanne","Ryan", "Adrian", "Bruno", "Allan", "Felipe", "Joanna", "Bob", "Joseph", "Chrystian", "Rudolph", "Matthias", "Juliane", "Boris", "Ademar", "Atenor", "Silvio"]
#List of last names for random generation
var last_names : Array = ["Smith", "Johnson", "Fini", "Brown", "Garcia", "Bigatto", "Williams", "Cremasco", "Galerani", "Santos", "Spielberg", "Burnquist", "Gentilli", "Nollan", "Stew", "Fulfaro", "Thenorio"]
